...
export class MainMenu extends Scene {
        ...
        if (storedUsername) {
            ...
            startButton.on('click', () => {
                ...
                if (username) {
                    ...
                    axios.post('https://pearl-hunters-server.vercel.app/users/register', { username })
                        .then(response => {
    ...
    createStartButton(storedUsername) {
        ...
        axios.post('https://pearl-hunters-server.vercel.app/users/login', { username: storedUsername })
            .then(response => {
